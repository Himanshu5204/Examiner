...
const QuestionCard = ({ question, index, selectedOption, onSelectOption }) => {
  // const [persistedOption, setpersistedOption] = useState("");
  // const getSelectedOption = () => {
  //   const answers = JSON.parse(localStorage.getItem('answers'))
  //   const op = persistIndex;
  //   console.log(op, answers, answers[op]);
  //   if (answers[op] != "") {
  //     setpersistedOption(answers[op]);
  //     console.log("Persisted", answers[op])
  //     return true;
  //   }
